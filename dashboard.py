...
class RMS:
    def __init__(self,root):
        ...
        btn_exit=Button(M_Frame,text="Exit",command=self.exit_,font=("goudy old style",15,"bold"),bg="#0b5377",fg="white",cursor="hand2").place(x=1120,y=5,width=200,height=40)
        ...
        self.notes_text = scrolledtext.ScrolledText(self.canvas, wrap=WORD, height=10, bg="lightgrey", fg="black",font=("goudy old style",15,"bold"))
        self.notes_text.insert(INSERT, "\t         NOTES ⬇️\n")
        self.notes_text.pack(fill=BOTH, expand=True)

        # Entry widget for adding new notes
        self.note_entry = scrolledtext.ScrolledText(self.canvas, wrap=WORD, height=5, bg="grey", fg="white",font=("goudy old style",15,"bold"))
        ...
        #  "Add Note" button
        self.add_note_button = Button(self.canvas, text="Add Note", command=self.add_note,font=("goudy old style",15,"bold"),bg="#0b5377",fg="white",cursor="hand2",height=1,width=370)
