...
class Register:
    def __init__(self,root):
        ...
        left=Label(self.root,image=self.left,text='Student Result \n Management System',compound='center',fg='white',font=("goudy old style",24,"bold"),highlightbackground="darkgreen", highlightthickness=5).place(x=80,y=100,width=400,height=500)
